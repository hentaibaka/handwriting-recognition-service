...
def recognize_text(model, converter, opt, image, device):
...
def recognize_text_from_images(image_pieces, model_dict, device):
...
def extract_text_from_image(image_or_path, recognize_model, gpu):
    ...
    recognized_text = [
        " ".join(recognize_text_from_images(image_piece, recognize_model, device))
