...
class ImageWithRectanglesWidget(widgets.Widget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        for string in self.page.string_set.all():
            ...
            html += f'<div class="rectangle" data-x1="{string.x1}" data-y1="{string.y1}" data-x2="{string.x2}" data-y2="{string.y2}" style="{style}"><span class="rectangle-text">{string.text}</span></div>'
        html += '</div>'
